...
module BranchResolverUnit (
   ...
   input                                                branch_predictor_result_i,
   ...
   output         reg                                   is_branched_o,
   output         reg     [31:0]                        branched_address_o,
   output         reg                                   is_branched_address_valid_o,
   output         reg                                   is_branch_predictor_true_o
...
always@ (posedge clk_i) begin
    if(rst_i) begin
        is_branch_predictor_true_o<=0;
        is_branched_address_valid_o<=0;
...
module BranchResolverUnit (
    ...
    input wire [31:0] branch_predictor_address_i,
