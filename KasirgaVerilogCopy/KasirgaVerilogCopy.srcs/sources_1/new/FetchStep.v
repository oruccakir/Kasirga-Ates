...
always @(posedge clk_i) begin
    if (rst_i) begin
        ...
        if ((coz_bos_i && buyruk_gecerli) || yanlis_tahmin) begin//bellekten bilgi geldiyse???aşama boş kalabilir mi? ve çöz boş veya yanlış dallanma tahminiyse belleğe istek atılır.
                bellek_ps_o = ps;
                bellek_istek_o = 1'b1;
                buyruk_gecerli = 0;
            end
